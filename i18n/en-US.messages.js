...
export default defineMessages({
  ...
  "REPLUGGED_COMMAND_ERROR_GENERIC": "Something went wrong, please try again later. If this issue persists, please contact the Replugged team.",
  ...
  "REPLUGGED_COMMAND_LIST_OPTION_STATUS_DESC": "Whether to show addons that are enabled, disabled or both",
  ...
  "REPLUGGED_COMMAND_LIST_ERROR_SPECIFY": "You need to specify whether to send a plugin or theme list",
  ...
  "REPLUGGED_NOTICES_WELCOME_NEW_USER": "Welcome! Replugged has been successfully injected into your Discord client. Feel free to join our Discord server for announcements, support and more!",
  ...
  "REPLUGGED_SETTINGS_KEEP_TOKEN_DESC": "Prevents Discord from removing your token from localStorage, reducing the numbers of unwanted logouts.",
  "REPLUGGED_SETTINGS_NO_CLYDE": "Eradicate Clyde",
  "REPLUGGED_SETTINGS_NO_CLYDE_DESC": "Replaces [Clyde]({clydeUrl}) in Replugged commands with a mixed range of avatars and usernames selected by plug-in developers - fallbacks to \"Replugged\" by default.",
  "REPLUGGED_SETTINGS_RESTART": "This setting requires you to restart Discord to take effect. Do you want to restart Discord now?",
  "REPLUGGED_SNIPPET_APPLIED": "Snippet Applied",
  "REPLUGGED_SNIPPET_APPLY": "Apply Snippet",
  "REPLUGGED_SNIPPET_LINE1": "Snippet from #css-snippets applied the {date, date, medium} at {date, time, medium}",
  ...
  "REPLUGGED_UPDATES_OPTS_AUTO_DESC": "Replugged will automatically check for updates and show you an alert when one is available. Updates will not be installed until you choose to update it. Only official addons will be checked automatically.",
  ...
  "REPLUGGED_UPDATES_OPTS_CONCURRENCY_DESC": "How many concurrent tasks Replugged will run in background to check for updates. Minimum 1. If unsure, leave 2.",
  "REPLUGGED_UPDATES_OPTS_DEBUG": "Debugging Information",
  "REPLUGGED_UPDATES_OPTS_DEBUG_DESC": "Things that you may find useful for troubleshooting or flexing on some stats.",
  ...
  "REPLUGGED_UPDATES_OPTS_INTERVAL_DESC": "How frequently Replugged will check for updates. Minimum 10 minutes.",
  "REPLUGGED_UPDATES_OPTS_RELEASE": "Change Release Channel",
  "REPLUGGED_UPDATES_OPTS_RELEASE_DESC": "You can choose between the stable branch, or the development branch. Stable branch will only get major updates, security and critical updates. If unsure, stay on stable.",
  "REPLUGGED_UPDATES_OPTS_RELEASE_DEVELOP_BTN": "Switch to development branch",
  "REPLUGGED_UPDATES_OPTS_RELEASE_MODAL": "Are you sure you want to change your release channel? Replugged will reload your Discord client.",
  ...
  "REPLUGGED_UPDATES_TOAST_NEW": "{count, plural, =1 {# new update} other {# new updates}} available!",
  ...
  "REPLUGGED_PLUGIN_INSTALL_RELOAD_PROMPT_BODY": "{name} requires a reload to work properly. Reload now?",
  ...
  "REPLUGGED_DEVELOPER_MODE_WARNING": "You are currently running Replugged in developer mode and Replugged will not be able to update itself. [Switch to production mode]({url}).",
  ...
  "REPLUGGED_SETTINGS_ADDON_EMBEDS_DESC": "Show a card with information on an addon when a store/install link is shared in chat.",
  "REPLUGGED_SETTINGS_RESTART_TITLE": "Restart Required",
  "REPLUGGED_SETTINGS_TRANSPARENT": "Transparent Window",
  "REPLUGGED_SETTINGS_TRANSPARENT_DESC": "Makes the Discord window transparent, primarily useful for theming. **Requires restart**.",
  "REPLUGGED_SETTINGS_TRANSPARENT_ISSUES_WINDOWS": "****WARNING:**** This will break **window snapping**. In some cases, you may experience a black background, such as when the window is cut off at the top or bottom due to the monitor resolution, or when the development tools are open and docked.",
