...
export default defineMessages({
  ...
  "REPLUGGED_SETTINGS_KEEP_TOKEN_DESC": "Prevents Discord from removing your token from localStorage, reducing the numbers of unwanted logouts. **Requires restart**.",
  ...
  "REPLUGGED_SETTINGS_TRANSPARENT_ISSUES_WINDOWS": "This will break **window snapping**. In some cases, you may experience a black background, such as when the window is cut off at the top or bottom due to the monitor resolution, or when the development tools are open and docked.",
  ...
  "REPLUGGED_SETTINGS_WINDOW": "Window Customization",
