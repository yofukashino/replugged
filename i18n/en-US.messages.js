...
export default defineMessages({
  ...
  REPLUGGED_ADDON_AUTHORS_ONE: "Author: {author1}",
  REPLUGGED_ADDON_AUTHORS_TWO: "Authors: {author1} and {author2}",
  REPLUGGED_ADDON_AUTHORS_THREE: "Authors: {author1}, {author2}, and {author3}",
