...
export enum RepluggedIpcChannels {
  ...
  WATCH_QUICK_CSS = "REPLUGGED_WATCH_QUICK_CSS",
  UNWATCH_QUICK_CSS = "REPLUGGED_UNWATCH_QUICK_CSS",
  QUICK_CSS_CHANGED = "REPLUGGED_QUICK_CSS_CHANGED",
  ...
  READ_PLUGIN_PLAINTEXT_PATCHES = "REPLUGGED_READ_PLUGIN_PLAINTEXT_PATCHES",
  ...
  GET_BACKGROUND_COLOR = "REPLUGGED_GET_BACKGROUND_COLOR",
  SET_BACKGROUND_COLOR = "REPLUGGED_SET_BACKGROUND_COLOR",
}
